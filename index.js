...
function createMapData(){
    ...
    Object.entries(stateList).forEach(([k,v]) => {
        ...
        obj['id'] = 'US-' + v
        obj['value'] = aggregate
        obj['grade'] = reportCardShow[v]['Grade']['Grade for Selected Aspects Below']
        // console.log(obj)
        res.push(obj)
    })
    console.log(res)
...
function updateChart(){
   ...
   //       Object.entries(v).forEach(([k2,v2]) => {
   //          Object.entries(v2).forEach(([k3,v3]) => {
   //             id = weights_translate[k3] 
   //             console.log(k3)
   //             console.log(id)
   //             console.log(weights[id])
   //             if (weights[id]==0){
   //                console.log('for deletion')
   //                console.log(id)
   //                delete reportCardShow[k][k2][k3]
   //             }
   //          })
   //       })
   //    }
...
function updateStateHTML(data){
   ...
   //  html+= '<p></p>'
    html += '<h2>Voting Rights Map: ' + state + '</h2>'
    html += '<br>'
    html += '<p> <b>Grade</b>: ' + showJSON['Grade']["Grade for Selected Aspects Below"] + ' (for selected aspects) </p>'
    html+= '<br>'
